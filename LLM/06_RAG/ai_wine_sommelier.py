...
def search_wine_review(query):
    ...
    vector_store = PineconeVectorStore(
        index_name = 'winemag-data',   # 저장할 index 명
...
def ai_wine_sommelier_rag(query):
    ...
    recommend_wine_chain = RunnableLambda(recommend_wines)

    chain = dish_flavor_chain | search_wine_review_chain | recommend_wine_chain
